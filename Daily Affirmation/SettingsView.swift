            ...
            VStack(spacing: 0) {
                ...
                ScrollView {
                    VStack(spacing: 20) {
                            ...
                            HStack {
                                VStack(alignment: .leading, spacing: 4) {
                                    Text("Testing Mode")
                                        .font(.system(size: 18, weight: .bold))
                                        .foregroundColor(.black)
                                    Text("Enable subscription testing mode")
                                        .font(.system(size: 14, weight: .medium))
                                        .foregroundColor(.black.opacity(0.6))
                                }
                                ...
                                Toggle("", isOn: Binding(
                                    get: { subscriptionManager.isTestingMode },
                                    set: { newValue in
                                        if newValue {
                                            subscriptionManager.enableTestingMode()
                                        } else {
                                            subscriptionManager.disableTestingMode()
                                        }
                                    }
                                ))
                        ...
                        // Subscription Status Toggle (only visible when testing mode is enabled)
                                ...
                                HStack {
                                    VStack(alignment: .leading, spacing: 4) {
                                        Text("Premium Subscription")
                                            .font(.system(size: 18, weight: .bold))
                                            .foregroundColor(.black)
                                        Text("Simulate subscription status")
                                            .font(.system(size: 14, weight: .medium))
                                            .foregroundColor(.black.opacity(0.6))
                                    }
                                    ...
                                    Toggle("", isOn: Binding(
                                        get: { subscriptionManager.hasTimeRangeAccess },
                                        set: { newValue in
                                            subscriptionManager.toggleTestingSubscription(newValue)
                                        }
                                    ))
                                    .toggleStyle(SwitchToggleStyle(tint: Color(red: 0.659, green: 0.902, blue: 0.812)))
                                }
                                ...
                                VStack(alignment: .leading, spacing: 8) {
                                    HStack {
                                        Text("Testing Mode:")
                                            ...
                                            .foregroundColor(.black.opacity(0.7))
                                        Spacer()
                                        Text(subscriptionManager.isTestingMode ? "Enabled" : "Disabled")
                                            .font(.system(size: 14, weight: .semibold))
                                            .foregroundColor(subscriptionManager.isTestingMode ? .orange : .secondary)
                                    }
                                    ...
                                    HStack {
                                        Text("Premium Access:")
                                            ...
                                            .foregroundColor(.black.opacity(0.7))
                                        Spacer()
                                        Text(subscriptionManager.hasTimeRangeAccess ? "Active" : "Inactive")
                                            .font(.system(size: 14, weight: .semibold))
                                            .foregroundColor(subscriptionManager.hasTimeRangeAccess ? Color(red: 0.659, green: 0.902, blue: 0.812) : .secondary)
                                    }
                                }
                            }
                            .padding(.horizontal, 24)
                        ...
                        VStack(spacing: 12) {
                            ...
                            Text("This section is for testing premium features during development. Testing mode overrides real subscription status. Remember to disable testing mode before releasing the app.")
                                .font(.system(size: 14, weight: .medium))
                                .foregroundColor(.black.opacity(0.7))
                                .multilineTextAlignment(.leading)
                        }
